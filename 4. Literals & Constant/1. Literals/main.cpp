...
int main()
{
    /* A Literals is a peace of data that is directly stored in memory & we do 
     not have to go through a variable name to access it */
    ...
    cout << std::dec <<  "The hex number2 is : " << hex_number2 <<endl;
    
    //Representing colors with hex
    int black_color {0xffffff};
    cout << "Black color is : " << std::dec << black_color << endl;
